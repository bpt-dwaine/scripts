...
[color=red]
        ...
        if (DropLocation := LV_DragDrop(A_GuiControl))[/color]
...

{
    ...
    static ScrollBarWidth, ScrollBarHeight, BorderX, BorderY, [color=red]LV_DragDrop[/color]
...
;     iItem := A_EventInfo
    ...
    [color=red]GuiControlGet, ControlPos, Pos, %ControlID%[/color]
